...
def generate_test_questions(source_text: str) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        prompt = f"""
        Создай минимум 10 тестовых вопросов по тексту ниже, содержать минимум 3-5 вариантов ответов. Каждый вопрос должен быть в формате JSON как в примере:

        {{
          "text": "<p>Вопрос в HTML</p>",
          "text_abstract": "Краткая формулировка вопроса",
          "type_id": 1,
          "reviewable": false,
          "answers": {{
