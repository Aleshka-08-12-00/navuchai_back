...
def get_column_mapping(view_name: str) -> Dict[str, str]:
    ...
    mappings = {
        'analytics_user_performance': {
            ...
            "total_test_groups_completed": "Всего завершенных групп тестов",
            "completed_test_groups": "Завершенные группы тестов",
        ...
        'analytics_test_statistics': {
            ...
            "test_group_id": "ID группы тестов",
            "test_group_name": "Название группы тестов",
            "test_group_description": "Описание группы тестов",
        ...
        'analytics_category_performance': {
            ...
            "total_test_groups": "Всего групп тестов",
